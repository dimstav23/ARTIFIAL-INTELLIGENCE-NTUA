...
/*
    ...
    cairo_text_path( cr, "Movement Visualization" );
    y += LEGEND_LINE_HEIGHT;
    cairo_move_to( cr, x, y );
    cairo_text_path( cr, "Artificial Intelligence 2015 - 2016" );
    y += LEGEND_LINE_HEIGHT;
    //cairo_move_to( cr, x, y );
   // cairo_text_path( cr, "Dimitris Stavrakakhs Athanasiou Nikolaos" );
    cairo_fill( cr );
*/
	y += LEGEND_LINE_HEIGHT;
    y += LEGEND_LINE_HEIGHT;
